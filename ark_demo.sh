...
alias captaind="cargo run --bin captaind --"
...
echo "an Ark server and a couple of clients that can send"
...
echo "- \`captaind\`: Compiles and runs \`captaind\`"
