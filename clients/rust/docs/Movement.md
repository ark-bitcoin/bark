...
**input_vtxos** | **Vec<String>** | A list of [Vtxo] IDs that were consumed by this movement and are either locked or unavailable. | 
...
**metadata** | Option<**String**> | Miscellaneous metadata for the movement. This is JSON containing arbitrary information as defined by the subsystem that created the movement. | [optional]
